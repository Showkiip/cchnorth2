        ...
        <div class="row">
            <div class="col-lg-9">
                ...
                <div class="row justify-content-center">
                    <div class="col mb-4">
                        <div class="row align-items-center pb-4 pb-md-2 appear-animation"
                            ...
                            <div class="col-md-5 col-xl-4 pe-lg-0 mb-4-5 mb-lg-0">
                                <div class="border-radius overflow-hidden">
                                    <a href="demo-real-estate-agents-detail.html">
                            ...
                            <div class="col-md-7 col-xl-8 ps-lg-4">
                                ...
                                <p class="text-3-5 mb-3-5">Sed consequat euismod diam, eu ultrices nulla ullamcorper ac.
                                    Praesent hendrerit lorem nec gravida ultrices. Morbi vitae odio eu mauris dapibus
                                    posuere. </p>
                                <p class="pt-2 mb-3">
                                    <a href="demo-real-estate-agents-detail.html"
                                        class="custom-view-more d-inline-flex font-weight-semibold text-color-primary text-decoration-none">
                                        View More
                        ...
                        <div class="row align-items-center pb-4 pb-md-2 appear-animation"
                            ...
                            <div class="col-md-7 col-xl-8 ps-lg-4">
                                ...
                                <h3 class="text-default text-uppercase text-3 ls-0 mb-0">Listed Properties: 3</h3>
                                <ul
                                    class="social-icons social-icons-clean social-icons-icon-dark social-icons-medium my-3">
                                    <li class="social-icons-facebook">
                                        <a href="http://www.facebook.com/" target="_blank" title="Facebook"><i
                                                class="fab fa-facebook-f"></i></a>
                                    </li>
