        ...
        <div class="container position-relative z-index-2">
            <div class="row text-center text-md-start py-5">
                <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                    ...
                    <p class="text-color-light opacity-7 mb-0">Sed consequat euismod diam, eu ultrices nulla ullamcorper ac
                    </p>
                </div>
    ...
    <div class="container py-5 my-3">
        <div class="row">
            <div class="col-lg-9">
                ...
                <p class="font-weight-medium text-4">Founded in 2001 by John Doe, gravida nibh vel. Aene <span
                        ...
                        data-plugin-options="{'flagClassOnly': true}">nisi elit consequat ipsum</span> nec sagittis sem nibh
                    id elit. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non
                    mauris vitae erat consequat. </p>

                <p class="text-3-5 line-height-9 pb-2">Sed consequat euismod diam, eu ultrices nulla ullamcorper ac.
                    Praesent hendrerit lorem nec gravida ultrices. Morbi vitae odio eu mauris dapibus posuere. Etiam congue
                    est et enim scelerisque rhoncus vel vitae dui. Duis velit ipsum, mattis a mauris ultrices, rhoncus
                    malesuada odio. Aliquam consectetur erat id ullamcorper aliquam. Curabitur condimentum, justo non
                    commodo aliquet, sapien massa consectetur justo, a faucibus sapien felis non tellus.</p>

                <div class="float-end border-radius overflow-hidden ms-4 mb-4 mb-lg-0 p-relative top-8">
                    <img src="img/demos/real-estate/generic/generic-1.jpg" class="img-fluid w-100" style="max-width: 393px;"
                        alt="" />
                </div>

                <p class="text-3-5 line-height-9">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet
                    libero id nisi euismod, sed porta est consectetur. Vestibulum auctor felis eget orci semper vestibulum.
                </p>
                ...
                <p class="text-3-5 line-height-9">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet
                    ...
                    est consectetur. Vestibulum auctor felis eget orci semper vestibulum.</p>
                                    ...
                                    <div class="card-body overflow-hidden p-relative z-index-1">
                                        <a href="#" class="text-decoration-none">
                                            ...
                                            <span class="custom-card-info-img d-block">
                                                <img src="img/demos/real-estate/listing/listing-1-thumb.jpg"
                                                    class="img-fluid">
                                            </span>
                                    ...
                                    <div class="row">
                                        <div class="form-group mb-2">
                                            <input type="text" value=""
                                                ...
                                                class="form-control bg-color-light box-shadow-none border-0"
                                                name="phone" id="phone" required placeholder="Phone *">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group mb-2">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-9 text-center text-lg-start mb-4 mb-lg-0">
                    <h2 class="mb-4 text-color-light mb-0">For <span class="font-weight-extra-bold">Residential And
                            Commercial </span> Properties</h2>
                    <p class="font-weight-semibold text-color-light text-4 opacity-7 mb-0">Our Staff is trained to find any
                        location you need!</p>
                </div>
                <div class="col-lg-3">
                    <div class="d-grid gap-2">
                        <a href="demo-real-estate-contact.html"
                            class="btn btn-primary font-weight-semibold border-0 text-3 text-uppercase mt-4 btn-py-3">Contact
                            Us
                            <img width="27" height="27" src="img/demos/real-estate/icons/arrow-right.svg"
                                alt="" data-icon
