    ...
    <div class="container py-3">
        <div class="row py-5">
            <div class="col-md-4 col-lg-3">
                ...
                <p class="mb-0">
                    Sherthang olding skardu , <br>
                    GilgitBaltistan , Pakistan<br>
                    Phone : +92 342 6768847<br>
                    Email : <a class="text-color-secondary"
                        href="mailto:shan57409@gmail.com">shan57409@gmail.com</a>
                </p>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                ...
                <nav class="nav-footer">
                    <ul class="list-unstyled mb-0">
                        <li>
                            <a href="demo-real-estate-agents.html"
                                class="custom-color-2 text-decoration-none">
                                Agents
                            </a>
                        </li>
