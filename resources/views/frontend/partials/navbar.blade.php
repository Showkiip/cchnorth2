                ...
                <div class="header-row py-2">
                            ...
                            <nav class="header-nav-top">
                                <ul class="list list-unstyled list-inline mb-0">
                                    <li class="list-inline-item me-4 mb-0">
                                        <i
                                            class="icons icon-phone text-color-secondary text-4 position-relative top-4 me-1"></i>
                                        <a href="tel:+923426768847"
                                    ...
                                    <li class="list-inline-item me-4 mb-0 d-none d-lg-inline-block">
                                        <i
                                            class="icons icon-location-pin text-color-secondary text-4 position-relative top-4 me-1"></i>
                                        <a href="#"
                                            class="text-default text-hover-secondary font-weight-medium text-decoration-none text-2">
                                            Sherthang olding skardu , GilgitBaltistan , Pakistan
                                        </a>
                                    </li>
                                    <li class="list-inline-item me-4 mb-0 d-none d-md-inline-block">
                                        <i
                                            class="icons icon-envelope text-color-secondary text-4 position-relative top-4 me-1"></i>
                                        <a href="mailto:shan57409@gmail.com"
                                            class="text-default text-hover-secondary font-weight-medium text-decoration-none text-2">
                                            shan57409@gmail.com
                                        </a>
                                    </li>
                    ...
                    <div class="header-column justify-content-end">
                        <div class="header-row">
                            <ul class="list list-unstyled list-inline mb-0">
                                <li class="list-inline-item me-4 mb-0">
                                    <a href="blog-large-image-sidebar-right.html"
                                        class="text-default text-hover-secondary font-weight-semibold text-decoration-none text-1">
                                        BLOG
                                    </a>
                                </li>
                    ...
                    <div class="header-row">
                        <div class="header-logo">
                            <a href="demo-real-estate.html">
                                <img alt="Porto" width="123" height="48" data-sticky-width="123"
                                    data-sticky-height="48"
                                    src="{{ asset('frontend/img/demos/real-estate/logo.png') }}">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="header-row">
                            ...
                            <div
                                ...
                                <nav class="collapse">
                                    <ul class="nav nav-pills" id="mainNav">
                                        ...
                                        <li>
                                            <a class="nav-link {{ Request::routeIs('frontend.packages') ? 'active' : '' }}"
                                                href="{{ route('frontend.packages') }}">
                                                Packages
                                            </a>
                                        </li>
                                        <li class="dropdown">
                                            <a class="nav-link dropdown-toggle {{ Request::routeIs('frontend.about.agents') || Request::routeIs('frontend.about.who-we-are') ? 'active' : '' }}"
                                                href="#">
                                                About
                                            </a>
                                            <ul class="dropdown-menu">
                                                <li class="bg-hover-primary"><a class="dropdown-item text-hover-light"
                                                        href="{{ route('frontend.about.agents') }}">Agents</a></li>
                                                <li class="bg-hover-primary"><a class="dropdown-item text-hover-light"
                                                        href="{{ route('frontend.about.who-we-are') }}">Who
                                                        We Are</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a class="nav-link {{ Request::routeIs('frontend.contact-us') ? 'active' : '' }}"
                                            ...
                                            <ul class="dropdown-menu custom-fullwidth-dropdown-menu ms-0">
                                                <li>
                                                    <div class="dropdown-mega-content mt-3 mt-lg-0">
                                                        <form class="form-style-3" id="propertiesFormHeader"
                                                            action="demo-real-estate-properties.html" method="POST">
                                                            <div class="container p-0">
                                                                <div class="row">
                                                                    <div class="col-lg-2 mb-2 mb-lg-0">
                                                                        <select
                                                                            class="form-select form-control text-default box-shadow-none"
                                                                            name="propertiesPropertyType"
                                                                            data-msg-required="This field is required."
                                                                            id="propertiesPropertyType" required="">
                                                                    ...
                                                                    <div class="col-lg-2 mb-2 mb-lg-0">
                                                                        <select
                                                                            ...
                                                                            <option value="1">Miami
                                                                            </option>
                                                                            <option value="2">New York
                                                                            </option>
                                                                            <option value="3">Houston
                                                                            </option>
                                                                    ...
                                                                    <div class="col-lg-2 mb-2 mb-lg-0">
                                                                        <div class="d-grid gap-2">
                                                                            <input type="submit" value="Search Now"
                                                                                class="btn btn-secondary font-weight-semibold border-0 p-relative bottom-3 text-1 text-uppercase mt-1 btn-px-4 btn-py-2">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <div
                            ...
                            <div class="header-nav-feature header-nav-features-search d-inline-flex">
                                <ul
                                    class="header-social-icons social-icons social-icons-lg d-none d-sm-block social-icons-clean ms-0">
                                    ...
                                    <li class="social-icons-twitter"><a href="http://www.twitter.com/"
                                            target="_blank" title="Twitter"><i class="text-4 fab fa-twitter"></i></a>
                                    </li>
